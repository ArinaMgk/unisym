\textbf{for }\textbf{\textit{Magice, C,C++}}
...
(2) \textbf{Inborn-String}: because the string is the inside type, it could be used directly, e.g. \verb|case 'phina':|;
