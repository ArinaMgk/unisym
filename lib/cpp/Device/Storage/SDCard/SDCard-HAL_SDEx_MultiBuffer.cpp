...
namespace uni {
	...
	// AKA HAL_SDEx_ConfigDMAMultiBuffer
	// BufferSize is in blocks; Buffer0 and Buffer1 share the same size.
	bool SecureDigitalCard_t::HAL_SDEx_ConfigDMAMultiBuffer(uint32* pDataBuffer0, uint32* pDataBuffer1, uint32 BufferSize) {
	...
	// AKA HAL_SDEx_ChangeDMABuffer
	bool SecureDigitalCard_t::HAL_SDEx_ChangeDMABuffer(SDMMC_DMABuffer Buffer, uint32* pDataBuffer) {
	...
	// AKA HAL_SDEx_ReadBlocksDMAMultiBuffer
	bool SecureDigitalCard_t::HAL_SDEx_ReadBlocksDMAMultiBuffer(uint32 BlockAdd, uint32 NumberOfBlocks, uint32* feedback) {
	...
	// AKA HAL_SDEx_WriteBlocksDMAMultiBuffer
	bool SecureDigitalCard_t::HAL_SDEx_WriteBlocksDMAMultiBuffer(uint32 BlockAdd, uint32 NumberOfBlocks, uint32* feedback) {
		SDMMC_DataInitTypeDef config;
		uint32 add = BlockAdd;
