...
\hline
\hline
\rowcolor[rgb]{0.95, 0.975, 1}
\textbf{REGION} & \textbf{PHONE-HEADER} & \textbf{ANSI} \\
\hline
China Mainland & +86 & GBK(ZH-CN) \\
\hline
\hline
...
The section does not include \textit{Kasha}. For AASM, Microsoft Macro Assembler, GNU-AS, Netwide Assembler.
...
\item \textbf{brancher} performance branches sample and process



\item \textbf{cal} calendar (Linux Command)



\item \textbf{clear} (Linux Command)
...
\item \textbf{fdump} filedump



\item \textbf{ffset} VirtualDiskCopier



\item \textbf{ret} return

Return the integer and echo string with new-line, usually used with \verb|&&| or \verb!||! instead of `echo'.



\item \textbf{segsel} SegmentSelector
