...
#
# Usage: perl make-tokhash.pl c  make-ins.dat make-reg.dat tokens.dat > ../data/tokhash.c
# Usage: perl make-tokhash.pl h  make-ins.dat make-reg.dat tokens.dat > ../data/tokens.h
#
use lib './perllib';
require 'phash.ph';
...
if ($output eq 'h') {
    ...
    print "/*\n";
    print " * This file is generated from make-ins.dat, regs.dat and token.dat\n";
    print " * by tokhash.pl; do not edit.\n";
    print " */\n";
    print "\n";

    print "#ifndef TOKENS_H\n";
    print "#define TOKENS_H\n";
    print "\n";
    print "#define MAX_KEYWORD $max_len /* length of longest keyword */\n";
    print "\n";
    print "#endif /* TOKENS_H */\n";
} elsif ($output eq 'c') {
    #
    # tokhash.c
    #
    ...
    printf "    if (ix >= numsof(tokendata))\n";
	# if (!strcmp(token, "arina")) { tv->t_integer = I_ARINA, tv->t_inttwo = C_none; return tv->t_type = TOKEN_INSN; }
