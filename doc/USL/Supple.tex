...
assert.h & uassert.h \\
\hline
ctype.h & \verb|c/uctype.h| \\
\hline
stdbool.h(C99+) & \verb|c/ustdbool.h| \\
\hline
string.h & ustring.h \\
\hline
limits.h & \multirow{3}{*}{archit.h by stdinc} \\
\cline{1-1}
stddef.h &  \\
\cline{1-1}
math.h &  \\
\hline
stdint.h & \multirow{2}{*}{integer.h by stdinc} \\
\cline{1-1}
inttypes.h &  \\
\hline
float.h & floating.h by stdinc \\
\hline
complex.h(C99+) & \multirow{3}{*}{number.h} \\
\cline{1-1}
fenv.h(C99+) &  \\
\cline{1-1}
tgmath.h(C99+) &  \\
\hline
errno.h & \multirow{2}{*}{msgface.h} \\
\cline{1-1}
signal.h &  \\
\hline
locale.h & loc.h \\
\hline
setjmp.h & \multirow{2}{*}{supple.h by stdinc} \\
\cline{1-1}
stdarg.h &  \\
\hline
time.h & datime.h \\
...
stdio.h & consio.h \\
\hline
wchar.h(C95+) & \multirow{2}{*}{widechar.h} \\
\cline{1-1}
wctype.h(C95+) &  \\
\hline
\hline
...
\textbf{Header}: \verb|cpp/reference|
...
\textbf{bitof}: give a binary digit in the form of \verb|bool|. 

\textbf{setof}: set a binary digit high or low level. If the second level parameter omitted, it set the digit (high).

\textbf{rstof}: reset a binary digit to low level.



\paragraph{Pointer} \

\textbf{Header}: \verb|cpp/pointer|
...
\textbf{Header}: (auto-inc-by \verb|stdinc|) \verb|c/system/supple.h|

\textbf{EXAMPLE - Greedy Parameter Using}
...
\textbf{EXAMPLE - Self-Defined Control Pointer}
