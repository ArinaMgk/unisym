; ASCII ARINA NASM
; TITLE KASHA BOOT Version First
...
;
BOOTADDR EQU 0X7C00; YO 7C00~7E00 THIS PROG
BOOTSEGM EQU 0X07C0
VRAMSEGM EQU 0XB800
PROGSEGM EQU 0X0800
...
JMP ENDO
TOESBX:
;### MOV AX,PROGSEGM ;RFA16 : want to insert
;### MOV DS,AX       ;RFA16 : want to insert
JMP 0x0800:0x0001    ;RFA16 : want to change: JMP PROGSEGM:1
