...
\T{C c} $\Psi$ $\psi$\begin{itemize}
	\item c \B{nat. constant} $\approx 299,792,458 m/s \approx 3d8 m/s$
...
\item e \B{constant} $= 1 + \dfrac{1}{1!} + \dfrac{1}{2!} + ... + \dfrac{1}{n!} \approx 2.71828182845904...$
%(Arn.) 离散极限
...
\item e \B{nat. constant} $\approx 1.602D19$
...
\T{P p} $\Pi$ $\pi$ \begin{itemize}
	\item $\pi $ \B{constant} $= 4*(1-\dfrac{1}{3}+\dfrac{1}{5}-...) \approx 3.141592653589793...$
	% (ARN.) 连续极限
