...
#
# $ ls -1 *mac ./macros/*.mac ./output/*.mac | tr '\n' ' '
# ./macros/altreg.mac ./macros/smartalign.mac ./output/outaout.mac ./output/outas86.mac ./output/outbin.mac ./output/outcoff.mac ./output/outelf.mac ./output/outmacho.mac ./output/outobj.mac ./output/outrdf.mac ./output/outrdf2.mac standard.mac version.mac
...
# Generate macros.c
#
open(OUT,"> ../data/macros.c\0") or die "unable to open macros.c\n";
...
print OUT "_ESYM_C uint64_t crc64 (uint64_t crc, const char *string);\n";
print OUT "_ESYM_C uint64_t crc64i(uint64_t crc, const char *string);\n";
print OUT "#if 1\n";
...
print OUT "const unsigned char *aasm_stdmac_find_package(const char *package)\n";
print OUT "{\n";
...
print OUT  "\n";
print OUT  "    if (StrCompareInsensitive(packages[ix].package, package))\n";
print OUT  "        return NULL;\n";
print OUT  "\n";
