...
namespace uni {
	...
	public:
		...
		// AKA GIC_EnableDistributor / Disable
		inline void enDistributor(bool ena = true) const {
			self[GICReg::CTLR].setof(0, ena);
		}
		...
		// AKA GIC_GetGroup = GIC_GetSecurity
		uint32 getGroup(Request_t IRQn) const;
		// AKA GIC_SetGroup = GIC_SetSecurity
		...
		// AKA GIC_EnableInterface
		inline void enInterface(bool ena = true) const {
			self[GICInterface::CTLR].setof(0, ena);
		}
		...
		// AKA GIC_DistributorImplementer
		Reference DistributorImplementer(void) const {
			return self[GICReg::IIDR];
		}
		...
		void SendSGI(Request_t IRQn, uint32 target_list, uint32 filter_list) const;

		// AKA
		// Provides information about the implementer and revision of the CPU interface.
		Reference GetInterfaceIdentification() const {
			return self[GICInterface::IIDR];
		}
